...
#define BYTE_MULTIPLIER (1<< (8-BYTE_RSHIFT))
...
void init_logging() {
  ...
  sprintf(logfilename,"mkdir ../logfiles/demoWallerDAC-y%d-m%02d-d%02d-h%02d-m%02d-s%02d.src",
  ...
  sprintf(logfilename,"cp Makefile *.c *.h ../logfiles/demoWallerDAC-y%d-m%02d-d%02d-h%02d-m%02d-s%02d.src",
          (tB->tm_year+1900),(1+tB->tm_mon),tB->tm_mday,
           tB->tm_hour,tB->tm_min,tB->tm_sec);
  ...
  sprintf(logfilename,"../logfiles/demoWallerDAC-y%d-m%02d-d%02d-h%02d-m%02d-s%02d.logfile",
          (tB->tm_year+1900),(1+tB->tm_mon),tB->tm_mday,
           tB->tm_hour,tB->tm_min,tB->tm_sec);
